    ...
    public function getAllTakeOffTable(TakeOff $take_off_table)
    {
        ...
        ->with([
            ...
            'takeOffTableField' => function($q){
                ...
                ->select('take_off_table_fields_inputs.take_off_table_field_id', 'take_off_table_fields_inputs.row_no', 'take_off_table_fields.take_off_table_id', 'take_off_table_fields.measurement_id', 'unit_of_measurements.name',  'take_off_table_fields_inputs.value')
                ->groupBY('take_off_table_fields_inputs.row_no', 'take_off_table_fields_inputs.take_off_table_field_id', 'take_off_table_fields.take_off_table_id', 'take_off_table_fields.measurement_id', 'unit_of_measurements.name',  'take_off_table_fields_inputs.value');
            }
